...
default_variant_group_uid = "variant_group_uid" # default variant group uid
default_variant_uid = "variant_uid" # default variant uid
...
def get_credentials():
    ...
    credentials = {
        ...
        "variant_group_uid": os.getenv("VARIANT_GROUP_UID", default_variant_group_uid),
        "variant_uid": os.getenv("VARIANT_UID", default_variant_uid)
    }
    return credentials
